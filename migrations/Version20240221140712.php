 ...
 */
final class Version20240221140712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liste (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE album_list (liste_id INT NOT NULL, album_id INT NOT NULL, INDEX IDX_20C34E58E85441D8 (liste_id), INDEX IDX_20C34E581137ABCF (album_id), PRIMARY KEY(liste_id, album_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, roles JSON NOT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE users_liste (users_id INT NOT NULL, liste_id INT NOT NULL, INDEX IDX_1B858EBD67B3B43D (users_id), INDEX IDX_1B858EBDE85441D8 (liste_id), PRIMARY KEY(users_id, liste_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE album_list ADD CONSTRAINT FK_20C34E58E85441D8 FOREIGN KEY (liste_id) REFERENCES liste (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE album_list ADD CONSTRAINT FK_20C34E581137ABCF FOREIGN KEY (album_id) REFERENCES album (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE users_liste ADD CONSTRAINT FK_1B858EBD67B3B43D FOREIGN KEY (users_id) REFERENCES users (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE users_liste ADD CONSTRAINT FK_1B858EBDE85441D8 FOREIGN KEY (liste_id) REFERENCES liste (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE album_list DROP FOREIGN KEY FK_20C34E58E85441D8');
        $this->addSql('ALTER TABLE album_list DROP FOREIGN KEY FK_20C34E581137ABCF');
        $this->addSql('ALTER TABLE users_liste DROP FOREIGN KEY FK_1B858EBD67B3B43D');
        $this->addSql('ALTER TABLE users_liste DROP FOREIGN KEY FK_1B858EBDE85441D8');
        ...
        $this->addSql('DROP TABLE users_liste');
